...
export default function App (){
    ...
    useEffect(()=> {
        window.localStorage.setItem("saved-feedbacks", JSON.stringify(feedbacks));}, [feedbacks]
    )
    ...
    const resetFeedback = ()=> {
      ...
      return(
              <div>
                ...
                <Options
                goodFeedback={() => updateFeedback("good")} neutralFeedback={() => updateFeedback("neutral")} badFeedback={() => updateFeedback("bad")}
